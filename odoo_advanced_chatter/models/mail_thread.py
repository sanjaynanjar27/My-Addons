...
class Message(models.AbstractModel):
    ...
    def message_post(self, *,
        ...
        # partner_ids = request.env['res.partner'].sudo().search([('restrict_mail','=',True)]).ids
        print("Partner IDS Before : ", partner_ids)
        ...
        # print("Partner Ids From Msg Values : ",msg_values['partner_ids'])
        ...
        # print("Author Subscribe : ",author_subscribe)
        if author_subscribe:
