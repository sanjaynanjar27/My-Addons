...
function assertProductPrice(product, pricelist_name, quantity, expected_price) {
  return function () {
    var pricelist = posmodel.pricelists.find(
...
var steps = [
  {
    ...
    run: function () {
      ...
      var product_desk_pad = posmodel.db.search_product_in_category(
        0,
        "Desk Pad",
      )[0];
      ...
      assertProductPrice(product_letter_tray, "Public Pricelist", 0, 4.8)()
        .then(
          assertProductPrice(product_letter_tray, "Public Pricelist", 1, 4.8),
        )
        ...
        .then(
          assertProductPrice(product_wall_shelf, "min_quantity ordering", 1, 2),
        )
        .then(
          assertProductPrice(product_wall_shelf, "min_quantity ordering", 2, 1),
        )
        .then(
          assertProductPrice(
            product_letter_tray,
        ...
        .then(
          assertProductPrice(product_whiteboard, "Public Pricelist", 1, 3.2),
        )
        .then(function () {
